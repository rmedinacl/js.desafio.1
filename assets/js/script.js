...
function aumentarUnidades() {
  ...
  console.log("En amuentar: el valorTotal es = " + valorTotal + " y la nuevaCantidad es = " + nuevaCantidad)
...
//Creo el condicional que solo se lleva a cabo la función si el número cantidadValue es mayor a 0
  if (cantidadValue > 0) {
    ...
    console.log("En disminuir: el valorTotal es = " + valorTotal + " y la nuevaCantidad es = " + nuevaCantidad)
